...
<tr>
    ...
    <td><img src="{{url('uploads/banner/'.$item->image)}}" width="100px" height="100px" alt=""></td>
    <td>{{$item->title}}</td>
    ...
    <td>
        ...
        @if($item->status==1)
        <a class="btn btn-success" href="{{url('admin/banner/status/0',$item->id)}} ">Active</a>
        @else 
        <a class="btn btn-danger" href="{{url('admin/banner/status/1',$item->id)}} ">Deactive</a>
        @endif
